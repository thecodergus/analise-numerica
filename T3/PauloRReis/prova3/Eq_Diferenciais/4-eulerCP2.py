...
# def true_euler(f, k, x0, y0, h, v, n):
#     for i in range(n):
#         x0 += h        
#         y0 += h * f(x0, y0, k, v)
...
# def euler_mid(f, k, x0, y0, h, v, n):
#     for _ in range(n):
#         m1 = f(x0, y0, v, k)
#         m2 = f(x0 + h / 2, y0 + (h / 2) * m1, v, k)
#         y0 = y0 + h * m2
#         x0 += h
#         yield x0, y0
...
#     r2 = true_euler(f, k, x0, y0, h, v, n)
#     print(r2)
#     # r2 = euler_mid(f, k, x0, y0, h, v, n)
#     # for i, v in r2:
#     #     print(f"{i} - {v},")
